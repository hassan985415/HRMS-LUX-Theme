...
<!--        >-->
          ...
          >
            <template v-slot:top>
              <v-toolbar
                flat
              >
                <v-toolbar-title><h3>{{ $t("modification.title") }}</h3></v-toolbar-title>
                <v-spacer></v-spacer>
                  <template>
                    <v-btn
                      color="primary"
        ...
        <v-card v-if="dialog">
          <v-card-title>
            <span v-if="view" class="headline">View Modification </span>
              ...
              <v-form ref="form">
                <v-container class="py-0">
                  <v-row>
                    ...
                    >
                      <v-text-field
                        :label="$t('modification.nameArabic')"
                        class="direction"
                    ...
                    >
                      <v-text-field
                        :label="$t('modification.nameEnglish')"
...
<!--              <v-col cols="12" sm="6" md="6"><h3> Flag </h3> </v-col>-->
<!--              <v-col cols="12" sm="6" md="6"><span>{{ editedItem.flag}} </span> </v-col>-->
<!--            </v-row>-->
<!--          </v-card-text>-->
<!--          <v-card-actions>-->
<!--            <v-spacer></v-spacer>-->
...
export default {
  ...
  data(){
    return{
      ...
      headers: [
        ...
        { text: this.$i18n.t("modification.nameEnglish"), value: 'en_name' },
        { text: this.$i18n.t("modification.nameArabic"), value: 'ar_name' },
        { text: this.$i18n.t("modification.flag"), value: 'flag' },
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? this.$t('modification.new') :  this.$t('modification.edit')
    }
  },
  watch: {
    dialog: function (val) {
