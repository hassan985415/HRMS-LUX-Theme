...
<!--        >-->
          ...
          >
            <template v-slot:top>
              <v-toolbar
                flat
              >
                <v-toolbar-title><h3>{{ $t("gosiSubscription.title") }}</h3></v-toolbar-title>
                <v-spacer></v-spacer>
                  <template>
                    <v-btn
                      color="primary"
        ...
        <v-card v-if="dialog">
          <v-card-title>
            <span v-if="view" class="headline">View Gosi Subscription </span>
              ...
              <v-form ref="form">
                <v-container class="py-0">
                  <v-row>
                    ...
                    >
                      <v-text-field
                        :label="$t('gosiSubscription.nameArabic')"
                        class="direction"
                    ...
                    >
                      <v-text-field
                        :label="$t('gosiSubscription.nameEnglish')"
...
export default {
  ...
  data(){
    return{
      ...
      headers: [
        ...
        { text: this.$i18n.t("gosiSubscription.nameEnglish"), value: 'en_name' },
        { text: this.$i18n.t("gosiSubscription.nameArabic"), value: 'ar_name' },
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? this.$t('gosiSubscription.new') : this.$t('gosiSubscription.edit')
    }
  },
  watch: {
    dialog: function (val) {
