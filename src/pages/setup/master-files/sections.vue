...
<!--        >-->
        ...
        <v-card v-if="dialog">
          <v-card-title>
            <span v-if="view" class="headline">View Section </span>
...
export default {
  ...
  data(){
    return{
      ...
      headers: [
        ...
        { text: this.$i18n.t("section.nameEnglish"), value: 'en_name' },
        { text: this.$i18n.t("section.nameArabic"), value: 'ar_name' },
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? this.$t('section.new') : this.$t('section.edit')
    }
  },
  watch: {
    dialog: function (val) {
