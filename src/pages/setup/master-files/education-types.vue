...
<!--        >-->
        ...
        <v-card v-if="dialog">
          <v-card-title>
            <span v-if="view" class="headline">View Education Type </span>
              ...
              <v-form ref="form">
                <v-container class="py-0">
                  <v-row>
                    ...
                    >
                      <v-text-field
                        :label="$t('education.educationRemark')"
...
<!--              <v-col cols="12" sm="6" md="6"><h3> Educ Remark </h3> </v-col>-->
<!--              <v-col cols="12" sm="6" md="6"><span>{{ editedItem.educ_remark}} </span> </v-col>-->
<!--              <v-col cols="12" sm="6" md="6"><h3> Is Sponsored </h3> </v-col>-->
<!--              <v-col cols="12" sm="6" md="6"><span>{{ editedItem.is_sponsored}} </span> </v-col>-->
<!--            </v-row>-->
<!--          </v-card-text>-->
<!--          <v-card-actions>-->
<!--            <v-spacer></v-spacer>-->
...
export default {
  ...
  data(){
    return{
      ...
      headers: [
        ...
        { text: this.$i18n.t("education.nameEnglish"), value: 'en_name' },
        { text: this.$i18n.t("education.nameArabic"), value: 'ar_name' },
        { text: this.$i18n.t("education.educationRemark"), value: 'educ_remark' },
        { text: this.$i18n.t("education.isSponsored"), value: 'is_sponsored' },
  ...
  computed: {
    formTitle () {
      return this.editedIndex === -1 ? this.$t('education.new') : this.$t('education.edit')
    }
  },
  watch: {
    dialog: function (val) {
