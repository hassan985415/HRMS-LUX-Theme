  ...
  <v-container id="user-profile" fluid tag="section">
    <v-row justify="center">
      <v-col cols="12" md="12">
        ...
        <!--          class="px-5 py-3"-->
        <!--        >-->
        <v-data-table :headers="headers" :items="cityData" sort-by="en_name">
          <template v-slot:top>
            <v-toolbar flat>
              ...
              <v-dialog v-model="dialog" max-width="500px">
                ...
                <v-card>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn color="blue darken-1" text @click="save" rounded>
                      Save
                    </v-btn>
                  </v-card-actions>
                </v-card>
              ...
              <v-dialog v-model="dialogDelete" max-width="390px" persistent>
                <v-card>
                  <v-card-title class="headline"
                    >Are you sure you want to delete this country?</v-card-title
                  >
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn
