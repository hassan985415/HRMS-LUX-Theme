<template>
  <div class="flex-grow-1">
    <div class="d-flex align-center py-3">
      <div>
        <div class="display-1">Edit User {{ userInfo.name && `- ${userInfo.name}` }}</div>
    ...
    <v-tabs-items v-model="tab">
      <v-tab-item>
        <account-tab ref="tabs-account" :user="userInfo"></account-tab>
      </v-tab-item>
...
export default {
  ...
  computed : {
    userInfo () {
      return this.$store.state.app.user.user
    }
  }
}
</script>
